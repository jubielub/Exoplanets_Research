-- Avoids errors if tables already exist in DB
...
-- Creating the Stellar Properties table
...
-- Creating Exoplanet Physical Properties table
...
-- Creating Planet NA & K Atmospheric Absorption Paper Info table
...
-- Creating Planet NA & K Atmospheric Absorption Conclusion table
